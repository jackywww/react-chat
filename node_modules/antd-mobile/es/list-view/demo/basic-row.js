...
var BasicRowDemo = function (_React$Component) {
    ...
    function BasicRowDemo(props) {
        ...
        _this.onEndReached = function (_event) {
            ...
            setTimeout(function () {
                _this.rData = assign({}, _this.rData, _this.genData(++pageIndex));
                _this.setState({
    ...
    _createClass(BasicRowDemo, [{
        ...
        value: function render() {
            ...
            return React.createElement(ListView, { dataSource: this.state.dataSource, renderHeader: function renderHeader() {
                ...
                }, renderRow: row, renderSeparator: separator, pageSize: 4, scrollRenderAheadDistance: 500, scrollEventThrottle: 20, onEndReached: this.onEndReached, onEndReachedThreshold: 10 });
        }
    }]);
