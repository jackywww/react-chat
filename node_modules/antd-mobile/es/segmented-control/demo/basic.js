    ...
    _createClass(BasicTagExample, [{
        ...
        value: function render() {
            return React.createElement(
                ...
                React.createElement(SegmentedControl, { values: ['切换一', '切换二'], disabled: true }),
                ...
                React.createElement(SegmentedControl, { values: ['切换一', '切换二', '切换三'], tintColor: '#ff0000', style: { height: 40, width: 280 } }),
                React.createElement(WhiteSpace, { size: 'lg' }),
                React.createElement(
                    Text,
                    null,
                ...
                React.createElement(SegmentedControl, { selectedIndex: 1, values: ['切换一', '切换二', '切换三'] }),
                React.createElement(WhiteSpace, { size: 'lg' }),
                React.createElement(
                    Text,
                    null,
                ...
                React.createElement(SegmentedControl, { values: ['切换一', '切换二', '切换三'], onChange: this.onChange, onValueChange: this.onValueChange })
            );
        }
    }]);
