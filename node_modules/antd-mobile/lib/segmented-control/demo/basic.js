    ...
    (0, _createClass3['default'])(BasicTagExample, [{
        ...
        value: function render() {
            return _react2['default'].createElement(
                ...
                _react2['default'].createElement(_antdMobile.SegmentedControl, { values: ['切换一', '切换二'], disabled: true }),
                ...
                _react2['default'].createElement(_antdMobile.SegmentedControl, { values: ['切换一', '切换二', '切换三'], tintColor: '#ff0000', style: { height: 40, width: 280 } }),
                _react2['default'].createElement(_antdMobile.WhiteSpace, { size: 'lg' }),
                _react2['default'].createElement(
                    _reactNative.Text,
                    null,
                ...
                _react2['default'].createElement(_antdMobile.SegmentedControl, { selectedIndex: 1, values: ['切换一', '切换二', '切换三'] }),
                _react2['default'].createElement(_antdMobile.WhiteSpace, { size: 'lg' }),
                _react2['default'].createElement(
                    _reactNative.Text,
                    null,
                ...
                _react2['default'].createElement(_antdMobile.SegmentedControl, { values: ['切换一', '切换二', '切换三'], onChange: this.onChange, onValueChange: this.onValueChange })
            );
        }
    }]);
